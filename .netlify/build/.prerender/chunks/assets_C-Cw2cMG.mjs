import { $ as UnsupportedImageFormat, E as LocalImageUsedWrongly, H as RemoteImageNotAllowed, P as NoImageMetadata, Q as UnsupportedImageConversion, T as InvalidImageService, ct as isRemotePath, d as ExpectedNotESMImage, f as FailedToFetchRemoteImageDimensions, j as MissingImageDimension, l as ExpectedImage, lt as joinPaths, pt as removeQueryString, t as AstroError, u as ExpectedImageOptions, x as IncompatibleDescriptorOptions } from "./errors_CStDCjdR.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service_BLEwaqct.mjs").catch((e) => {
...
//#endregion
export { inferRemoteSize as a, resolveSrc as c, verifyOptions as i, getImage as n, isESMImportedImage as o, baseService as r, isRemoteImage as s, getConfiguredImageService as t };
