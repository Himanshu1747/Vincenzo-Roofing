import { A as ForbiddenRewrite, H as LocalsReassigned, L as InvalidGetStaticPathsEntry, M as GetStaticPathsInvalidRouteParam, N as GetStaticPathsRequired, Q as NoMatchingStaticPathFound, R as InvalidGetStaticPathsReturn, S as ClientAddressNotAvailable, U as MiddlewareNoDataOrNextCalled, V as LocalsNotAnObject, W as MiddlewareNotAResponse, _ as trimSlashes, a as collapseDuplicateSlashes, at as ResponseSentError, b as AstroResponseHeadersReassigned, c as hasFileExtension, ct as SessionStorageSaveError, d as joinPaths, et as PageNumberParamNotFound, f as prependForwardSlash, g as slash, h as removeTrailingForwardSlash, ht as AstroError, i as collapseDuplicateLeadingSlashes, it as ReservedSlotName, j as GetStaticPathsExpectedParams, l as isInternalPath, lt as StaticClientAddressNotAvailable, mt as i18nNoLocaleFoundInPath, n as matchPattern, nt as PrerenderDynamicEndpointPathCollide, o as collapseDuplicateTrailingSlashes, ot as RewriteWithBodyUsed, p as removeLeadingForwardSlash, r as appendForwardSlash, s as fileExtension, st as SessionStorageInitError, tt as PrerenderClientAddressNotAvailable, ut as UnableToLoadLogger, v as ActionNotFoundError, x as CacheNotEnabled, y as ActionsReturnedInvalidDataError } from "./chunks/remote_B8XmU2D9.mjs";
import { A as clientAddressSymbol, C as isRoute500, D as REDIRECT_STATUS_CODES, E as DEFAULT_404_COMPONENT, M as originPathnameSymbol, N as pipelineSymbol, O as REROUTABLE_STATUS_CODES, P as responseSentSymbol$1, S as isRoute404, T as ASTRO_GENERATOR, _ as pushDirective, a as chunkToString, b as renderEndpoint, c as isRenderTemplateResult, d as decryptString, f as generateCspDigest, g as normalizeCspResourceEntry, h as isRenderInstruction, i as renderComponent, j as fetchStateSymbol, k as appSymbol, l as renderTemplate, n as renderPage, o as createSlotValueFromString, r as renderJSX, s as renderSlotToString, u as decodeKey, v as isAstroComponentFactory, w as ASTRO_ERROR_HEADER } from "./chunks/server_lm-JWyRL.mjs";
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/send-contact\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "send-contact",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/api/send-contact.js",
			"pathname": "/api/send-contact",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/send-estimate",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/send-estimate\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/api/send-estimate.js",
			"pathname": "/api/send-estimate",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
function createHandler({ notFoundContent }) {
	return async function handler(request, context) {
		...
		if (astroLocalsHeader) {
			if (middlewareSecretHeader !== "debc81ca-af7c-4293-a842-3b6439464036") return new Response("Forbidden", { status: 403 });
