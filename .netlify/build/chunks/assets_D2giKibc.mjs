import { B as LocalImageUsedWrongly, D as FailedToFetchRemoteImageDimensions, E as ExpectedNotESMImage, F as IncompatibleDescriptorOptions, K as MissingImageDimension, T as ExpectedImageOptions, Y as NoImageMetadata, d as joinPaths, ft as UnsupportedImageConversion, ht as AstroError, m as removeQueryString, pt as UnsupportedImageFormat, rt as RemoteImageNotAllowed, t as isRemoteAllowed, u as isRemotePath, w as ExpectedImage, z as InvalidImageService } from "./remote_B8XmU2D9.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service_CEUrOnyG.mjs").catch((e) => {
