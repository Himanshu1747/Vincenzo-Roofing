...
//#region src/pages/api/send-estimate.js
...
async function POST({ request }) {
	try {
		...
		const fromAddress = "himanshusaxena1747@gmail.com";
		const toAddress = "himanshusaxena1747@gmail.com";
		const html = `
...
//#endregion
//#region \0virtual:astro:page:src/pages/api/send-estimate@_@js
